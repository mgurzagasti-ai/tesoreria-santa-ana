 ...
 * @author tesoreria
 */
public class DDMYS extends javax.swing.JFrame implements Printable{
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(816, 670));
        setMinimumSize(new java.awt.Dimension(816, 670));

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));
        jPanel1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        jPanel1.setMaximumSize(new java.awt.Dimension(796, 800));
        jPanel1.setMinimumSize(new java.awt.Dimension(796, 800));
        jPanel1.setPreferredSize(new java.awt.Dimension(796, 800));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DDMYS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

...
import java.io.*;
import Ventanas.Anticipos_de_Haberes;
 ...
 * @author tesoreria
 */
public class ControladorExcelAdH implements ActionListener{
    ...
    public ControladorExcelAdH (Anticipos_de_Haberes vistaE, ModeloExcel modeloE){
        this.vistaE= vistaE;
